...
module.exports.languages = {
    "vi": {
        ...
        "notiBox": "Nhóm của bạn đã được admin phê duyệt để có thể sử dụng bot\nSpam Tao Kí Đầu =))",
        "approveSuccess": "Đã phê duyệt thành công %1 nhóm!",

        "cantGetPendingList": "Không thể lấy danh sách các nhóm đang chờ!",
        "returnListPending": "「TINNHANCHO」❮ Tổng số nhóm cần duyệt: %1 nhóm ❯\n\n%2",
        "returnListClean": "「TINNHANCHO」Hiện tại không có nhóm nào trong hàng chờ"
    },
    "en": {
