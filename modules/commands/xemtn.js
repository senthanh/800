module.exports.config = {
	...
	hasPermssion: 0,
	credits: "BuiChiThong",
	description: "Kiểm tra tin nhắn thành viên trong nhóm lệnh này chỉ sửa lại một chút",
...
module.exports.languages = {
    "vi": {
        ...
        "mention": "%1 Đang có %3 tin nhắn trong nhóm.",
        "myself": "Bạn có %2 tin nhắn trong nhóm."
    },
    "en": {
...
module.exports.run = async function ({ args, api, event, Currencies, getText }) {
    ...
    try {
        ...
        if (args[0] == "all") {
            ...
            msg += `--Trang ${page}/${numPage}--\nDùng ${global.config.PREFIX}xentn all để check số trang dùng 1/2/3/4/5 để lật từng trang`
