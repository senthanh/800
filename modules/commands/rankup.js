module.exports.config = {
 ...
 hasPermssion: 1,
 credits: "CThong",
 description: "Thông báo độ dễ thương cho từng thành viên (Fix lại tí thôi nha mấy anh)",
...
module.exports.languages = {
 "vi": {
  "on": "bật",
  "off": "tắt",
  "successText": "thành công thông báo độ dễ thương của thành viên!",
  "levelup": "Độ dễ thương của {name} đã đạt tới level {level} yêu cầu đồng chí bớt dễ thương lại <3"
 },
 "en": {
  "on": "on",
  "off": "off",
