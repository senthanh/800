module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "NTKhang", //mod láº¡i tĂ­ :)) D-Jukie
  description: "tá»± Ä‘á»™ng cáº¥m ngÆ°á»i dĂ¹ng náº¿u spam bot 5 láº§n/100s",
...
module.exports. run = ({api, event, args, Users,Threads}) => {
  return api.sendMessage("Tá»± Ä‘á»™ng cáº¥m ngÆ°á»i dĂ¹ng náº¿u spam bot 5 láº§n/2 phĂºt", event.threadID, event.messageID);
};
