...
module.exports.handleReply = async function({
  ...
  //Thêm, sửa các câu trả lời ở đây
	var D = [
    "sao <3", "cc:3", "lmm?", "gì em", `${m} admin đéo gọi gọi tao lj!`, `${m} gọi cljt`, `${m}, gọi tao lj😢`, `${m}, gọi cc à gọi lj  vl ❤`, `${m},đánh nhau không em ❤`, `${m}, sao cu:3`, `${m}, yêu Admin bot đi rồi hãy gọi`, `${m}, yêu em ❤`, `${m}, [Góc Donate] im mồm ?`, `${m}, câm`
    ],
		y = D[Math.floor(Math.random() * D.length)];

  //Các câu gọi bot
	["bot", "bot ơi", "bot oi", "yêu bot", "bot đâu","anh","xin bot","hi bot","go","chinh","anh chính","chính"].forEach((e => {
